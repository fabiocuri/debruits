...
CALENDAR_LABEL = os.environ.get("CALENDAR_LABEL", "Google")
# A second feed: an Outlook / Microsoft 365 *published* calendar ICS URL, which
# includes Teams meetings. Both feeds are merged in the agenda panel.
TEAMS_ICS_URL = os.environ.get("TEAMS_ICS_URL", "")
TEAMS_LABEL = os.environ.get("TEAMS_LABEL", "Teams")
AGENDA_DAYS = int(os.environ.get("AGENDA_DAYS", "7"))  # look-ahead window
AGENDA_MAX = int(os.environ.get("AGENDA_MAX", "20"))  # max events returned
