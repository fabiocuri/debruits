...
def train(
    ...
    Path("/content/drive/MyDrive/image/output/trained_models/").mkdir(
        parents=True, exist_ok=True
    )
    d_model.save("/content/drive/MyDrive/image/output/trained_models/d_model.h5")
    g_model.save("/content/drive/MyDrive/image/output/trained_models/g_model.h5")
    gan_model.save("/content/drive/MyDrive/image/output/trained_models/gan_model.h5")
...
if __name__ == "__main__":
    ...
    if train_type == "continue":
        ...
        stop_step = os.listdir("/content/drive/MyDrive/image/output/plots/")
        stop_step = int(
            sorted([int(x.split(".png")[0].split("plot_")[1]) for x in stop_step])[-1]
        )
